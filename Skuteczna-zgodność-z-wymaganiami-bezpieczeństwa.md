...
Skupia się na inwidualnej osobie, aby poprawnie kontrolować ich personalne dane. Dajemy ludzią właściela i kontrole nad danymi. Privacy in UE to GDPR + CIA.

### Privacy vs Confidentiality:

Confidentiality skupia się na tym, że dane są dostępne(autoryzowane) tylko przez wybrane jednostki lub organizacje. 

### Legal Implication: Implementując regulacje musimy wziąć pod uwagę prawo panujące w danej lokalizacji.

### Data Subject: Osoba, której dane są używane. Compilance musi brać pod uwagę right to access, erase their data, rectify(naprawa).

### CIA pod Privacy: 
- determinuje Ownership of Data, czyli kto rządzi.
- Data Inventory and Retention: szczegółowe rekordowanie danych, które muszą być zebrane i przetworzone. W razie problemu jak mają być usunięte.
- Right to be Forgotten: W GDPR data subject może prosić o usunięcie jego danych.

### Data Inventory:
Cyberspecjaliści powini zdefinować i zaimplementować data inventory, który będzie posiadał podział wrażliwych danych:
- Personaly Identifitable Information (PII)
- Proceted Health Information (PHI)
